 ...
 * For more information, see http://docs.codehaus.org/display/MAVEN/Versioning
 *
 * Schema:
 ...
 * @version $Id: ComparableVersion.java 661417 2008-05-29 17:41:01Z jdcasey $
 */
public class ProgramVersion implements Comparable<ProgramVersion> {

    /** the original value as specified in the constructor */
    private String value;

    /** the canonical version string */
    private String canonical;

    /** the actual version list items */
    ...
    private static class StringItem implements Item {
        ...
        private final static String[] QUALIFIERS = {
         ...
         * determine if a given qualifier makes the
         * version older than one without a qualifier, or more recent.
         */
        private static Comparable<String> RELEASE_VERSION_INDEX = String.valueOf(_QUALIFIERS.indexOf(""));
    ...
    private static class ListItem extends ArrayList implements Item {
        ...
        private static final long serialVersionUID = -7588193698698973443L;
        ...
        void normalize() {
            for (ListIterator iterator = listIterator(size()); iterator
                    .hasPrevious();) {
    ...
    public static ProgramVersion of(String version) {
        return new ProgramVersion(version);
    }

    public static int compareVersions(String version, String other) {
        return ProgramVersion.of(version).compareTo(ProgramVersion.of(other));
    }
    ...
    @Override
    public int compareTo(ProgramVersion v) {
    ...
    public boolean equals(Object o) {
        return (o instanceof ProgramVersion)
                && canonical.equals(((ProgramVersion) o).canonical);
    }
