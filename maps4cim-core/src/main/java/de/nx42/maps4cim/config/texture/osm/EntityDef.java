...
public abstract class EntityDef {
    ...
    @NotNull(message="every entity must have a key")
    @NotBlank(message="the key of an entity must not be empty")
    public String key;
     ...
     * Use "^Foo$" to find only exact matches of "Foo" (or use {@link #value})
     */
    ...
    @NotNull(message="every entity must have a color reference")
    @NotBlank(message="the color reference of an entity must not be empty")
    public String color;
