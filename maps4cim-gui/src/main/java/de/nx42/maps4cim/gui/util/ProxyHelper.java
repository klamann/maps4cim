...
public class ProxyHelper {
    ...
    protected static final String regKeyProxyServer = "proxy.server";
    protected static final String regKeyProxyPort = "proxy.port";
    ...
    public static boolean hasProxyEnabled() {
